...
class WebClientAsync:
    ...
    async def send_request(self, # pylint: disable = too-many-arguments, too-many-locals
        ...
        await self._check_response_content(request_identifier, method, url, response, response_content_type)

        response_content_length = self._get_response_content_length(response)
        response_data = await self._get_response_data(request_identifier, method, url, response, response_content_type, response_obj_type)
    ...
    def _check_response_status(self, # pylint: disable = too-many-arguments, too-many-positional-arguments
        ...
        try:
            ...
            raise WebStatusException(request_identifier, method, url, response.status, response_data) from exception


    async def _check_response_content(self, # pylint: disable = too-many-arguments, too-many-positional-arguments
        ...
        try:
            ...
            raise WebContentException(request_identifier, method, url, response.status, response_content_as_text) from exception
    ...
    async def _get_response_data(self, # pylint: disable = too-many-arguments, too-many-positional-arguments, too-many-return-statements
            request_identifier, method, url, response: aiohttp.ClientResponse,
